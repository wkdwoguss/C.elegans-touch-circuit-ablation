...
def setup(parameter_set,
    ...
    AS_motors = []
    TW_cells = ['AVAL', 'AVAR', 'AVDL', 'AVDR', 'DVA', 'PVDL', 'PVDR', 'PLML', 'PLMR', 'AVM', 'ALML', 'ALMR']  # PATCHED: AVBL, AVBR, PVCL, PVCR removed (ablation)
    ...
    reference = "c302_%s_TouchTW_PVCAVBablated" % parameter_set
