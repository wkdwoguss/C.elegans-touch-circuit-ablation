...
def setup(parameter_set,
    ...
    AS_motors = []
    TW_cells = ['AVAL', 'AVAR', 'PVCL', 'PVCR', 'AVDL', 'AVDR', 'DVA', 'PVDL', 'PVDR', 'PLML', 'PLMR',
                'AVM', 'ALML', 'ALMR']  # PATCHED: AVBL, AVBR removed (ablation)
    ...
    reference = "c302_%s_TouchTW_AVBablated" % parameter_set
