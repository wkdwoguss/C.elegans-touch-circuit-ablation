...
def setup(parameter_set,
    ...
    AS_motors = []
    TW_cells = ['AVAL', 'AVAR', 'AVBL', 'AVBR', 'PVCR', 'AVDL', 'AVDR', 'DVA', 'PVDL', 'PVDR', 'PLML', 'PLMR', 'AVM', 'ALML', 'ALMR']  # PATCHED: PVCL removed (unilateral ablation)
    ...
    reference = "c302_%s_TouchTW_PVCLablated" % parameter_set
    ...
    if generate:
        ...
        # PATCHED: posterior touch stimulus (mirrors the c302-only PLM stimulation protocol
        # validated separately: PLML/PLMR depolarised -> PVC/AVB/AVA responded)
