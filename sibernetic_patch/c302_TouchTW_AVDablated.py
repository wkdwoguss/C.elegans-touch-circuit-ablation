...
def setup(parameter_set,
    ...
    AS_motors = []
    TW_cells = ['AVAL', 'AVAR', 'AVBL', 'AVBR', 'PVCL', 'PVCR', 'DVA', 'PVDL', 'PVDR', 'PLML', 'PLMR', 'AVM', 'ALML', 'ALMR']  # PATCHED: AVDL, AVDR removed (ablation)
    ...
    reference = "c302_%s_TouchTW_AVDablated" % parameter_set
