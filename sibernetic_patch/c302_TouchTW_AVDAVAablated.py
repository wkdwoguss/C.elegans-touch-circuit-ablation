...
def setup(parameter_set,
    ...
    AS_motors = []
    TW_cells = ['AVBL', 'AVBR', 'PVCL', 'PVCR', 'DVA', 'PVDL', 'PVDR', 'PLML', 'PLMR', 'AVM', 'ALML', 'ALMR']  # PATCHED: AVAL, AVAR, AVDL, AVDR removed (ablation)
    ...
    reference = "c302_%s_TouchTW_AVDAVAablated" % parameter_set
